        ...
        <div className="pricing-card flex flex-col justify-between rounded-3xl border border-[var(--border-color)] bg-[var(--surface)] p-8 shadow-sm">
          <div>
            ...
            <div className="mt-4 flex items-baseline text-6xl font-extrabold">
              $0
              <span className="ml-1 text-2xl font-medium text-[var(--fg)]/50">
                {t("monthly")}
              </span>
            </div>
            <p className="mt-4 text-[var(--fg)]/70">{t("free_desc")}</p>

            <ul className="mt-8 space-y-4">
              <li className="flex items-center gap-3">
                <Check className="h-5 w-5 text-green-500" />
                <span className="text-[var(--fg)]/80">
                  {t("feature_unlimited_dict")}
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Check className="h-5 w-5 text-green-500" />
                <span className="text-[var(--fg)]/80">
                  {t("feature_unlimited_words")}
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Check className="h-5 w-5 text-green-500" />
                <span className="text-[var(--fg)]/80">
                  {t("feature_flashcards")}
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Check className="h-5 w-5 text-green-500" />
        ...
        <div className="pricing-card relative flex flex-col justify-between rounded-3xl border-2 border-primary-500 bg-[var(--surface)] p-8 shadow-xl shadow-primary-500/10">
          ...
          <div>
            ...
            <div className="mt-4 flex items-baseline gap-3">
              ...
              <span className="text-2xl font-medium text-[var(--fg)]/50">
                {t("monthly")}
              </span>
            </div>
            <p className="mt-4 text-[var(--fg)]/70">{t("premium_desc")}</p>
          ...
          <div className="mt-8 space-y-3">
            ...
            <p className="text-center text-sm text-[var(--fg)]/50 italic">
              Currently, we can&apos;t accept payments outside from Turkey due
              to limitations. We provide unlimited free plan for now.
            </p>
          </div>
        </div>
      </div>
