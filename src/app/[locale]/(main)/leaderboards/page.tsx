import { getLeaderboardData, type LeaderboardUser } from '@/actions/leaderboard';
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <div className="flex flex-col items-center text-center space-y-4 mb-14">
        ...
        <p className="text-lg text-[var(--fg)]/60 max-w-2xl">{t('subtitle')}</p>
      </div>

      <div className="space-y-16">
        <section>
          <h2 className="text-2xl font-black mb-8 flex items-center gap-3">
             <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 text-white shadow-lg shadow-amber-500/20">1</span>
             {t('top_performers')}
          </h2>
          <LeaderboardHero 
            mostWords={mostWords}
        ...
        <section>
          <h2 className="text-2xl font-black mb-8 flex items-center gap-3">
             <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-500 text-white shadow-lg shadow-primary-500/20">10</span>
             {t('top_10')}
          </h2>
          <LeaderboardTable 
            top10={data.top10}
